...
HD_PWD='C:/Users/carlo/OneDrive/rea de Trabalho/driver_bcd_7seg/driver_bcd_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log driver_bcd_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source driver_bcd_7seg.tcl -notrace
