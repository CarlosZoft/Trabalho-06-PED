...
HD_PWD='C:/Users/carlo/OneDrive/rea de Trabalho/driver_bcd_7seg/driver_bcd_7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log driver_bcd_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source driver_bcd_7seg.tcl
